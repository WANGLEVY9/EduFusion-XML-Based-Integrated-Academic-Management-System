...
- 公共工具单元测试：[common/src/test/java/edu/fusion/common/util/XmlUtilTest.java](common/src/test/java/edu/fusion/common/util/XmlUtilTest.java)
- 集成服务业务测试：[integration-server/src/test/java/edu/fusion/integration/service/IntegrationServerTest.java](integration-server/src/test/java/edu/fusion/integration/service/IntegrationServerTest.java)
